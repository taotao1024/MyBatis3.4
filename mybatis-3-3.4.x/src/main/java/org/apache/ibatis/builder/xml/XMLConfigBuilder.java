...
public class XMLConfigBuilder extends BaseBuilder {
    ...
    /**
     * 按照方法维度
     * 将mybatis-config.xml配置文件中每一个节点的解析过程封装成了相应的方法
     *
     * @param root
     */
    ...
    /**
     * 解析<settings>节点 <settings>节点的配置是MyBaits全局性的配置，他们会改变MyBatis的运行时行为
     *
     * @param context
     * @return
     */
    ...
    /**
     * 解析<properties>节点并形成java.util.Properties对象
     *
     * @param context
     * @throws Exception
     */
    ...
    /**
     * 解析<databaseIdProvider>节点 数据源供应商
     *
     * @param context
     * @throws Exception
     */
        ...
        if (parent != null) {
            ...
            for (XNode child : parent.getChildren()) {
                ...
                if ("package".equals(child.getName())) {
                    ...
                    // 获取<mapper>节点resource、url、class属性 则三个属性互斥
                    String resource = child.getStringAttribute("resource");
                    String url = child.getStringAttribute("url");
                    String mapperClass = child.getStringAttribute("class");
                    // 如果如果<mapper>节点指定了resource、url 则创建XMLMapperBuilder对象
                    ...
                    if (resource != null && url == null && mapperClass == null) {
                        ...
                        // 如果<mapper>节点指定了class属性，则向MappeRegistry注册该Mapper接口
