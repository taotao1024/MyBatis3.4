...
public class MapperMethod {
    /**
     * 获取SQL语句的类型、Mapper的Id等信息
     */
    private final SqlCommand command;
    /**
     * 获取方法的签名信息、参数名、参数注解、返回类型等
     */
    ...
    public static class SqlCommand {
        ...
        public SqlCommand(Configuration configuration, Class<?> mapperInterface, Method method) {
            ...
            MappedStatement ms = this.resolveMappedStatement(mapperInterface, methodName, declaringClass,
                    configuration);
            if (ms == null) {
    ...
    public static class MethodSignature {
        ...
        // 用于处理分页查询 同时记录ResultHandler参数位置 用于处理从数据库中检索的每一行数据
        private final Integer rowBoundsIndex;
        // 用于解析Mapper方法中的参数名名称及参数注解信息
