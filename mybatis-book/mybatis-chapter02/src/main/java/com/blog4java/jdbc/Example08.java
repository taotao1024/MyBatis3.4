...
public class Example08 {
    ...
    public void testDbMetaData() {
        try {
            ...
            System.out.println("数据库是否支持:" + dmd.supportsResultSetType(ResultSet.TYPE_FORWARD_ONLY));
            System.out.println("数据库是否支持:" + dmd.supportsResultSetType(ResultSet.TYPE_SCROLL_INSENSITIVE));
            System.out.println("数据库是否支持:" + dmd.supportsResultSetType(ResultSet.TYPE_SCROLL_SENSITIVE));
            // System.out.println("数据库是否支持:" + dmd.supportsResultSetConcurrency(ResultSet. CONCUR_READ_ONLY));
            // System.out.println("数据库是否支持:" + dmd.supportsResultSetConcurrency(ResultSet. CONCUR_UPDATABLE));
