...
public class DynamicSqlExample {
    ...
    public void testDynamicSql()  {
        UserEntity09 entity = new UserEntity09();
        entity.setPhone("18700001111");
        List<UserEntity09> userList =  userMapper.getUserByEntity(entity);
        System.out.println(JSON.toJSONString(userList));
    }

    @Test
    public void testGetUserByPhoneAndName() {
        UserEntity09 userEntity = userMapper.getUserByPhoneAndName("18700001111", "User4");
        System.out.println(userEntity);
    }

    @Test
    public void testGetUserByNames() {
        List<UserEntity09> users = userMapper.getUserByNames(Arrays.asList("User4","User5"));
    ...
    public void testGetUserByName() {
        ...
        UserEntity09 userEntity = userMapper.getUserByName(userName);
        System.out.println(userEntity);
    }
}
